...
export const SuccessModal = ({ isOpen, onClose, userName }: SuccessModalProps) => {
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-gray-300 mb-6">
              Thank you {userName} for booking a call with us. We're excited to discuss how we can help your business grow with AI automation.
            </p>

            <div className="space-y-4 w-full">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="text-sm text-gray-400">What's next?</p>
                <p className="text-white">We'll send you an email shortly with the call details and preparation information.</p>
              </div>
            </div>
