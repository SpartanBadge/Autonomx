...
export const ContactSuccessModal = ({ isOpen, onClose, userName }: ContactSuccessModalProps) => {
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-gray-300 mb-6">
              Thank you {userName} for reaching out to us. We appreciate you taking the time to share your message.
            </p>

            <div className="space-y-4 w-full">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="text-sm text-gray-400">What's next?</p>
                <p className="text-white">Our team will review your message and get back to you within 24 hours.</p>
              </div>
            </div>
